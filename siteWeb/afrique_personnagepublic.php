...
<html lang="fr">
	...
	<h1>Niveau 2</h1>
	<h2>Afrique - Personnage public</h2>
	<form action="afrique_personnagepublic.php" method="POST">
	<div>
		<br>
		<label>Ma femme m'a attendu pendant un quart de sa vie, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_2_per)
								{									
									$request="UPDATE user SET 2_per='1' WHERE email='$email'";
									$result=mysql_query($request,$connexion);
									echo "<script>valid();</script>";
									echo "<a href='afrique_monument.php'>Enigme suivante</a>";									
