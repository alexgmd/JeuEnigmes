...
<html lang="fr">
	...
	<h1>Niveau 2</h1>
	<h2>Afrique - Géographie</h2>
	<form action="afrique_geographie.php" method="POST">
	<div>
		<br>
		<label>Mon premier s'applique aux objets d'occasion, mon second vient de l'éléphant et se vend très cher, mon tout est un pays d'Afrique, quel est-il ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_2_geo)
								{									
									$request="UPDATE user SET 2_geo='1' WHERE email='$email'";
									$result=mysql_query($request,$connexion);
									echo "<script>valid();</script>";
									echo "<a href='afrique_personnagepublic.php'>Enigme suivante</a>";									
