...
<html lang="fr">
	...
	<body>
	<img class="displayed" src="image/vietnam.jpe" width="100%" height="100%">
	<div id="wrap">
	<div id="main" class="clearfix">
	<?php include("menu.php"); ?>

	<h1>Niveau 1</h1>
	<h2>Asie - Gastronomie</h2>
	<form action="asie_gastronomie.php" method="POST">
	<div>
		<br>
		<label>Je suis l'aliment le plus consommé d'Asie, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_1_gas)
								{									
									$request="UPDATE user SET 1_gas='1' WHERE email='$email'";
									$result=mysqli_query($connexion,$request);
									echo "<script>valid();</script>";
									echo "<br><a href='asie_monument.php'>Enigme suivante</a>";									
