...
<html lang="fr">
	...
	<h1>Niveau 1</h1>
	<h2>Asie - Sport</h2>
	<form action="asie_sport.php" method="POST">
	<div>
		<br>
		<label>J'ai cette année créé un exploit majeur lors de la coupe du monde, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_1_spo)
								{									
									$request="UPDATE user SET 1_spo='1' WHERE email='$email'";
									$result=mysqli_query($connexion,$request);
									echo "<script>valid();</script>";
									echo "<br><a href='asie_geographie.php'>Enigme suivante</a>";									
