...
<html lang="fr">
	...
	<h1>Niveau 2</h1>
	<h2>Afrique - Monument</h2>
	<form action="afrique_monument.php" method="POST">
	<div>
		<br>
		<label>J'ai une tête d'Homme et un corps de Lion, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_2_mon)
								{									
									$request="UPDATE user SET 2_mon='1' WHERE email='$email'";
									$result=mysql_query($request,$connexion);
									echo "<script>valid();</script>";
									echo "<a href='amerique_gastronomie.php'>Enigme suivante</a>";									
