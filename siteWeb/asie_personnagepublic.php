...
<html lang="fr">
	...
	<h1>Niveau 1</h1>
	<h2>Asie - Personnage public</h2>
	<form action="asie_personnagepublic.php" method="POST">
	<div>
		<br>
		<label>Les frontières du pays que je dirige sont très surveillées, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_1_per)
								{									
									$request="UPDATE user SET 1_per='1' WHERE email='$email'";
									$result=mysqli_query($connexion,$request);
									echo "<script>valid();</script>";
									echo "<br><a href='afrique_monument.php'>Enigme suivante</a>";									
