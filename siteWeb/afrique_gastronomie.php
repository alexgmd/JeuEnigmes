...
<html lang="fr">
	...
	<h1>Niveau 2</h1>
	<h2>Afrique - Gastronomie</h2>
	<form action="afrique_gastronomie.php" method="POST">
	<div>
		<br>
		<label>Je suis un plat typique du nord de l'Afrique, qui suis-je ?</label>
				...
				if(isset($_SESSION['email']))
					{
						...
						if($connexion > 0)
						{
							...
							if(isset($_POST['submit']))
							{
								...
								if($reponse==$reponse_2_gas)
								{									
									$request="UPDATE user SET 2_gas='1' WHERE email='$email'";
									$result=mysql_query($request,$connexion);
									echo "<script>valid();</script>";
									echo "<a href='afrique_sport.php'>Enigme suivante</a>";									
